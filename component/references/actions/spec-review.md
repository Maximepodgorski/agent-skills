...
**Launch 4 subagents in parallel** (use Task tool with `run_in_background` or parallel calls). Each subagent receives the full spec content and reviews from its assigned perspective.
